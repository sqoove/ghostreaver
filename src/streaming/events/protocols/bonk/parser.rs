...
impl BonkEventParser {
    ...
    fn parse_buy_exact_in_instruction(
        ...
        let share_fee_rate = Scripts::readu64le(data, 16)?;
    ...
    fn parse_buy_exact_out_instruction(
        ...
        let amount_out = Scripts::readu64le(data, 0)?;
        let maximum_amount_in = Scripts::readu64le(data, 8)?;
        let share_fee_rate = Scripts::readu64le(data, 16)?;
    ...
    fn parse_mint_params(data: &[u8], offset: &mut usize) -> Option<MintParams> {
        ...
        let decimals = Scripts::readu8offset(data, *offset)?;
        *offset += 1;

        // Read name string length and content
        let name_len = Scripts::readu32le(data, *offset)? as usize;
        *offset += 4;
        ...
        *offset += name_len;
        ...
        let symbol_len = Scripts::readu32le(data, *offset)? as usize;
        *offset += 4;
        ...
        *offset += symbol_len;
        ...
        let uri_len = Scripts::readu32le(data, *offset)? as usize;
        *offset += 4;
    ...
    fn parse_curve_params(data: &[u8], offset: &mut usize) -> Option<CurveParams> {
        ...
        let curve_type = Scripts::readu8offset(data, *offset)?;
        *offset += 1;

        match curve_type {
            0 => {
                // Constant curve
                let supply = Scripts::readu64le(data, *offset)?;
                *offset += 8;
                let total_base_sell = Scripts::readu64le(data, *offset)?;
                *offset += 8;
                let total_quote_fund_raising = Scripts::readu64le(data, *offset)?;
                *offset += 8;
                let migrate_type = Scripts::readu8offset(data, *offset)?;
                *offset += 1;
    ...
    fn parse_vesting_params(data: &[u8], offset: &mut usize) -> Option<VestingParams> {
        let total_locked_amount = Scripts::readu64le(data, *offset)?;
        *offset += 8;
        let cliff_period = Scripts::readu64le(data, *offset)?;
        *offset += 8;
        let unlock_period = Scripts::readu64le(data, *offset)?;
        *offset += 8;
